...
export const GlobalStyles = createGlobalStyle`
  ...
  /* Fix for table cell hover background */
  .ant-table-cell-row-hover {
    background: ${({ theme }) => rgba(theme.palette.primary.main, 0.05)} !important;
  }
  ...
  .btn-secondary-outline {
    ...
    &:hover, &:focus {
      background-color: transparent;
      border-color: ${({ theme }) => darken(0.15, theme.palette.secondary.main)};
      color: ${({ theme }) => darken(0.15, theme.palette.secondary.main)};
    }
  }
  ...
  .btn-primary-outline {
    ...
    &:hover, &:focus {
      background-color: transparent;
      border-color: ${({ theme }) => darken(0.15, theme.palette.primary.main)};
      color: ${({ theme }) => darken(0.15, theme.palette.primary.main)};
    }
  }
  ...
  /* Fix for tooltip */
  .ant-tooltip-inner {
    background-color: ${({ theme }) => theme.palette.tooltipBg} !important;
  ...
  /* Fix for selected options in dropdown */
  ...
  /* Fix dropdown trigger background */
  ...
  /* Fix for header and sidebar in different layouts */
  .boxedLayout {
